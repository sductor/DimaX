 ...
 */
public RulesListBasedProactiveComponent() {lists = new HashMap();}
/**
 * Insert the method's description here.
...
public java.util.Vector getActionList(final String debut) {
	if (!lists.containsKey(debut)) this.createActionList(debut);
	return (Vector)lists.get(debut);
}
/**
 * Insert the method's description here.
 * Creation date: (07/06/00 13:12:56)
...
public java.util.Vector getConditionList(final String debut) {
	if (!lists.containsKey(debut)) this.createConditionList(debut);
	return (Vector)lists.get(debut);
}
/**
 * Insert the method's description here.
