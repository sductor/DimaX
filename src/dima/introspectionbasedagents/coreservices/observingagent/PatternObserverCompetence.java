 ...
 */
public abstract class PatternObserverCompetence extends BasicAgentCommunicatingCompetence<BasicCompetentAgent> {
...
//		public ObservationProtocol(final CommunicatingCompetentComponent com) {super(com);}
	...
	public PatternObserverCompetence(BasicCompetentAgent ag) throws UnrespectedCompetenceSyntaxException {
		super(ag);
	}
...
//							.get(n.getKey()));
	...
	@StepComposant(ticker=PatternObserverCompetence.notificationExpirationTime)
	public void clean() {
