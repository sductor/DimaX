package vieux.src.exec;

import java.util.ArrayList;
import java.util.Collections;
import java.util.HashMap;

import vieux.src.algo.*;
import vieux.src.algo.korig.AlgoKOptOriginal;
import vieux.src.algo.topt.AlgoKOptAPO;
import vieux.src.algo.topt.AlgoTOptAPO;
