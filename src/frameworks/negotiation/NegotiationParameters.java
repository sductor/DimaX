...
public class NegotiationParameters {
	...
	public static final long _timeToCollect =5000;//500;//
	public static final long _initiatorPropositionFrequency = 10;//(long) (ExperimentationProtocol._timeToCollect*0.5);//(long)
