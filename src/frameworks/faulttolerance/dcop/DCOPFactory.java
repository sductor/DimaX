...
public class DCOPFactory {
	...
	private static int nbAgentsMax;
	...
	public static void setParameters(int nbAgentsMax, 
			VariableType dcoptype,
			String simulationName){
		DCOPFactory.nbAgentsMax=nbAgentsMax;
	...
	public static DcopReplicationGraph constructDCOPGraph(String filename) {
		...
		try {
			rig.randomInitiaition(
					...
					5, 3,nbAgentsMax,//nbAgent,nbHost
...
//		assert s!=null;
	...
	public static AgentIdentifier intToIdentifier(int id){
		return ReplicationInstanceGraph.intToIdentifier(simulationName, nbAgentsMax, id);
	}
