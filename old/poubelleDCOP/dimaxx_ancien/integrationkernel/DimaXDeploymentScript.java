...
import dimaxx.deploymentAndExecution.DeploymentScript;
import dimaxx.deploymentAndExecution.RemoteHostExecutor;

public class DimaXDeploymentScript extends DeploymentScript{
...
//		NameServerImpl.main(s);;
		try {
			...
			LoggerManager.writeException(this, "Error while instanciating name server", e);
		}
	}
	...
	public void launchDarXServer(final RemoteHostExecutor host){
		try {
			...
			LoggerManager.writeException(this, "Error while instanciating "+ host, e);
		}
	}
	public void launchDarXServer(final String url, final int port){
		//TODO IMPORTAANT
	}
