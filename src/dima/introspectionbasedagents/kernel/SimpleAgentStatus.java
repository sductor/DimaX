...
public class SimpleAgentStatus extends GimaObject {
	 ...
	 */
	public void setCurrentlyExecutedBehavior(final MethodHandler mt) {
	 ...
	 * null otherwise
	 */
	public MethodHandler getCurrentlyExecutedBehavior() {
	...
	public String toString() {
		return 		"Agent Status :"
				...
				+ 	"\n    *** method : " + this.getCurrentlyExecutedBehavior()
