...
public abstract class Problem implements Serializable {
	 ...
	 * @return the number of decision variables.
	 */
	public void setNumberOfVariables(final int numberOfVariables) {
	 ...
	 */
	public double getLowerLimit(final int i) {
	 ...
	 */
	public double getUpperLimit(final int i) {
	 ...
	 * @param solution The <code>Solution</code> to evaluate.
	 */
	public void evaluateConstraints(final Solution solution) throws JMException {
	 ...
	 */
	public int getPrecision(final int var) {
	 ...
	 */
	public int getLength(final int var) {
		if (this.length_ == null) {
			return Problem.DEFAULT_PRECISSION;
		}
	 ...
	 */
	public void setSolutionType(final SolutionType type) {
