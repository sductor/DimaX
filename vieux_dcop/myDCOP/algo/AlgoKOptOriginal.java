...
import vieux.myDCOP.algo.KorigGainMsg.CommitInfo;
import vieux.myDCOP.algo.KorigGainMsg.GainInfo;
import vieux.myDCOP.algo.KorigGainMsg.LocalInfo;
...
public class AlgoKOptOriginal extends BasicAlgorithm {
	...
	private void init() {
		...
		this.korigView = new DcopAbstractGraph();
