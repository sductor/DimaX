...
public class XCSConstants implements Serializable
{
	...
	final private static long _Q = XCSConstants._M/XCSConstants._A;
	/**
	 * Constant for the random number generator (=_M mod _A).
	 */
	final private static long _R = XCSConstants._M%XCSConstants._A;
	...
	{
		final long hi   = XCSConstants.seed / XCSConstants._Q;
