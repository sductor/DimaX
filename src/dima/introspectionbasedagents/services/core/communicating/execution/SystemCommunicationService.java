package dima.introspectionbasedagents.services.core.communicating.execution;
...
import dima.introspectionbasedagents.services.core.communicating.SynchronousCommunicationComponent;
...
public class SystemCommunicationService implements SynchronousCommunicationComponent {
	...
	private Process executeOnProcess(final Process p, String cmd)
		...
		try {
			...
			throw new ErrorOnProcessExecutionException(ex);
		}
	}
	...
	public static void main(final String[] args) throws ErrorOnProcessExecutionException, WrongOSException{
		...
		String cmd = getBMips;//getLatence;
		...
		System.out.println("Commande : " + cmd);
		sortie = exec.executeWithBash(cmd);
		System.out.println("Sortie : " + sortie);
	}
}
