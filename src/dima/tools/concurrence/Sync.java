...
public interface Sync {
	...
	public static final long ONE_MINUTE = 60 * Sync.ONE_SECOND;

	/**  One hour, in milliseconds; convenient as a time-out value **/
	public static final long ONE_HOUR = 60 * Sync.ONE_MINUTE;

	/**  One day, in milliseconds; convenient as a time-out value **/
	public static final long ONE_DAY = 24 * Sync.ONE_HOUR;

	/**  One week, in milliseconds; convenient as a time-out value **/
	public static final long ONE_WEEK = 7 * Sync.ONE_DAY;
	...
	public static final long ONE_YEAR = (long)(365.2425 * Sync.ONE_DAY);

	/**  One century in milliseconds; convenient as a time-out value **/
	public static final long ONE_CENTURY = 100 * Sync.ONE_YEAR;
