...
import vieux.dcop_old.daj.awt.NodeVisual;
import vieux.dcop_old.daj.awt.Visualizer;
...
abstract public class Scheduler {
	...
	private AgentNode node[] = new AgentNode[nodeMax];
	...
	//--------------------------------------------------------------------------
	public void register(AgentNode t) {
	...
	public void schedule(int i) {
		...
		if (threadExec != -1) {
			AgentNode currentNode = (AgentNode) Thread.currentThread();
