...
//			if (!creation){
//				if (pref>0){
//					logMonologue("i've received upgrading contracts, I PREFER\n "+c1+" \n OVER "+c2, NegotiationProtocol.log_mirrorProto);
//					if (!this.getMyAgent().getMyResultingState(this.getMyAgent().getMyCurrentState(), c1).isValid())
//						this.logWarning("BUT DONT RESPECT RIGHT!!!!!!", LogService.onBoth);
//				} else if (pref<0){
//					logMonologue("i've received upgrading contracts, I PREFER\n "+c2+" \n OVER "+c1, NegotiationProtocol.log_mirrorProto);
//					if (!this.getMyAgent().getMyResultingState(this.getMyAgent().getMyCurrentState(), c1).isValid())
//						this.logWarning("BUT DONT RESPECT RIGHT!!!!!!", LogService.onBoth);
//				} else {
//					logMonologue("i've received upgrading contracts, "+c2+" \n AND "+c1+" are equivalent", NegotiationProtocol.log_mirrorProto);					
//				}
//			}
